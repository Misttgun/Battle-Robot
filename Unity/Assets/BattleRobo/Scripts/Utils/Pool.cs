...
namespace BattleRobo
{
    public class Pool : MonoBehaviour
    {
        ...
        public GameObject Spawn(Vector3 position, Quaternion rotation)
        {
            ...
            {
                //we don't have any inactive objects available, we have to instantiate a new one
                //check if the limited count allows new instantiations, if not, return nothing
        ...
        public void Despawn(GameObject instance)
        {
            ...
            {
                Debug.LogWarning("Can't despawn - Instance not found: " + instance.name + " in Pool " + name);
                return;
            }
        ...
        public void DestroyUnused(bool limitToPreLoad)
        {
            ...
            if (limitToPreLoad)
            {
                //start from the last inactive instance and count down until the index reached the limit amount
        ...
        /// <summary>
        /// Destroys a specific amount of inactive instances.
        /// </summary>
        ...
        //create an unique name for each instance at instantiation to differ them from each other in the editor
        ...
        //when this pool gets destroyed, clear instances lists
